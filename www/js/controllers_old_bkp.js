...
.controller("HomeCtrl", function($ionicHistory, $state, $scope, $ionicModal, $timeout, $http, $sessionStorage, $window, searchdate, $rootScope, $ionicLoading)
{
  ...
  {
    if(typeof $sessionStorage.userSession.name != "undefined") $scope.name = $sessionStorage.userSession.name;
...
.controller('BMDCtrl', function($sessionStorage,$ionicModal,$rootScope,$scope, $stateParams,$http,speciality,location,insurance,searchdate,$window,$timeout,$filter,$ionicLoading, $sessionStorage, $ionicHistory, $interval) {
  //alert("hi");
  $scope.roles = [];
  $scope.loginData = {};
  $scope.signUpData = {};
  ...
  $scope.userSession = $sessionStorage.userSession;
...
.controller('searchCtrl', function($sessionStorage, $ionicModal,$rootScope,$scope, $stateParams,$http,speciality,location,insurance,searchdate,$window,$timeout,$filter) {
    ...
    $scope.roles = JSON.parse($sessionStorage.roles);
