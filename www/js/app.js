...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services',"ngStorage", "multipleSelect", 'file-model','gm',"ngMaterial"]) //
  ...
  ////////////////////////////////////////////////////////////////////////////////
    ...
    $http.get(baseurl + "/userRole").then((data) => {
      ...
      //console.log("rolw");
      //console.log(data);
      $localStorage.roles = JSON.stringify(data.data);
    });
    $http.get(baseurl + "/get_all_speciality").then(function success(data) {
      ...
      $localStorage.spListMain = JSON.stringify(spListMain);
      $localStorage.splList = JSON.stringify(splList);
      $localStorage.spListid = JSON.stringify(spListid);
    });
    $http.get(baseurl + "/getlocation").then((locationData) => {
      $localStorage.location_data = JSON.stringify(locationData.data.data);
    ...
    $http.get(baseurl + "/get_all_language").then(function success(data) {
      ...
      $localStorage.langListMain = JSON.stringify(langListMain);
      $localStorage.langList = JSON.stringify(langList);
      $localStorage.langListid = JSON.stringify(langListid);
    });
    $http.get(baseurl + "/get_all_degree").then((data) => {
      ...
      $localStorage.degreeListMain = JSON.stringify(degreeListMain);
      $localStorage.degreeList = JSON.stringify(degreeList);
      $localStorage.degreeid = JSON.stringify(degreeid);
    });
    ////////////////////////////////////////////////////////////////////
    $http.get("http://ip-api.com/json").success(function(data)
    {
...
.state('app.doctor_service_view', {
          cache: false,
    url: '/doctor_service_view',
              views: {
                'menuContent': {
                  templateUrl: 'templates/doctor_service_view.html',
